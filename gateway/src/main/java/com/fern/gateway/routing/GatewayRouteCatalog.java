...
public final class GatewayRouteCatalog {
  ...
  public static List<GatewayRoute> routes() {
    return List.of(
        ...
        new GatewayRoute("/api/v1/sync", "sales-service", env("SALES_SERVICE_URL", "http://localhost:8087")),
        new GatewayRoute("/api/v1/devices/provision", "sales-service", env("SALES_SERVICE_URL", "http://localhost:8087")),
        new GatewayRoute("/api/v1/devices", "auth-service", env("AUTH_SERVICE_URL", "http://localhost:8081")),
