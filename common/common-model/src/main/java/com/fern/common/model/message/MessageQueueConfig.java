 ...
 */
public final class MessageQueueConfig implements ServiceDefinition {
    ...
    public ServiceCategory getServiceCategory() {
        return ServiceCategory.MESSAGE_QUEUE;
    }
    ...
    public boolean isDurableQueues() {
