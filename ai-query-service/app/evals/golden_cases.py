...
GOLDEN_CASES: tuple[GoldenCase, ...] = (
    ...
    GoldenCase(
        id="SAL-080",
        question="vì sao doanh thu tuần này giảm?",
        auth_roles=("region_manager",),
        auth_outlet_ids=(1, 2, 3),
        expected_route="data_query",
        expected_intent="revenue",
        expected_template_key="INS_SALES_DRIVER",
        expected_tables_subset=("analytics.ai_sales_daily",),
        tags=("revenue", "insight", "driver", "L2"),
    ),
    GoldenCase(
        id="SAL-081",
        question="hôm nay outlet nào bất thường?",
        auth_roles=("region_manager",),
        auth_outlet_ids=(1, 2, 3),
        expected_route="data_query",
        expected_intent="revenue",
        expected_template_key="ANOM_SALES",
        expected_tables_subset=("analytics.ai_sales_daily",),
        tags=("revenue", "insight", "anomaly", "L2"),
    ),
    GoldenCase(
        id="SAL-082",
        ...
        expected_route="data_query",
        expected_intent="revenue",
        expected_template_key="FORECAST_REVENUE",
        expected_tables_subset=("analytics.ai_sales_daily",),
        tags=("revenue", "insight", "forecast", "L2"),
    ),
    GoldenCase(
        id="SAL-022",
    ...
    GoldenCase(
        ...
        expected_tables_subset=("analytics.ai_inventory_on_hand_daily",),
        tags=("inventory", "L2"),
    ...
    GoldenCase(
        ...
        expected_route="data_query",
        expected_intent="inventory",
        expected_template_key="ANOM_INVENTORY",
        expected_tables_subset=("analytics.ai_inventory_movement_daily",),
        tags=("inventory", "insight", "anomaly", "L2"),
    ),
    # ---- §8 FINANCE / P&L ---------------------------------------------------
    GoldenCase(
        id="FIN-001",
        ...
        expected_tables_subset=("analytics.ai_finance_daily",),
    ...
    GoldenCase(
        ...
        expected_route="data_query",
        expected_intent="pnl",
        expected_template_key="INS_FINANCE_DRIVER",
        expected_tables_subset=("analytics.ai_finance_daily",),
        tags=("pnl", "rbac-finance", "insight", "driver", "L2"),
    ),
    GoldenCase(
        id="FIN-RBAC-001",
        question="lợi nhuận tháng này theo cửa hàng",
    ...
    GoldenCase(
        ...
        notes=(
            ...
            "must return unsupported without producing SQL."
        ),
    ),
    GoldenCase(
        id="UNSUPPORTED-001",
        question="Chênh lệch tiền mặt expected vs counted hôm qua là bao nhiêu?",
        auth_roles=("outlet_manager",),
        auth_outlet_ids=(1,),
        expected_route="data_query",
        expected_response_kind="unsupported",
        expects_sql=False,
        tags=("unsupported", "cash-control", "L9"),
    ),
    GoldenCase(
        id="UNSUPPORTED-002",
        question="Thời gian chuẩn bị món trung bình theo bếp tuần này",
        auth_roles=("outlet_manager",),
        auth_outlet_ids=(1,),
        expected_route="data_query",
        expected_response_kind="unsupported",
        expects_sql=False,
        tags=("unsupported", "kitchen-sla", "L9"),
    ),
    GoldenCase(
        id="UNSUPPORTED-003",
        question="Tỷ lệ khách hàng quay lại tháng này là bao nhiêu?",
        auth_roles=("outlet_manager",),
        auth_outlet_ids=(1,),
        expected_route="data_query",
        expected_response_kind="unsupported",
        expects_sql=False,
        tags=("unsupported", "crm", "L9"),
    ),
